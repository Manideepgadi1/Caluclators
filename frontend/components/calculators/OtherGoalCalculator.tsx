    ...
    <div className="min-h-screen p-4 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 animate-slide-in bg-white rounded-2xl p-8 shadow-xl">
          ...
          <h1 className="text-4xl font-bold bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-transparent mb-2">Your Other Goal</h1>
          <p className="text-gray-600 text-lg">Plan for any custom financial goal</p>
        </div>
